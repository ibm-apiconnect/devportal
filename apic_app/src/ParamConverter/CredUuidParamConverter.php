...
/**
 * Class CredUuidParamConverter
 *
 * @package Drupal\apic_app\ParamConverter
 */
class CredUuidParamConverter implements ParamConverterInterface {
  ...
  public function applies($definition, $name, Route $route): bool {
    return (!empty($definition['type']) && $definition['type'] === 'apic_app.credid');
  }
