  ...
  public function buildForm(array $form, FormStateInterface $form_state, NodeInterface $appId = NULL, $credentials = NULL): array {
    ...
    if ($this->module_handler->moduleExists('clipboardjs')) {
      ...
      if (isset($this->creds['client_id'])) {
        $form['client_id'] = [
          '#markup' => Markup::create('<div class="clientIDContainer"><label for="client_id" class="field__label">' . t('Key') . '</label><div class="bx--form-item appID js-form-item form-item js-form-type-textfield form-group"><input id="clientIDInput" class="clipboardjs" aria-labelledby="clientIDInputLabel" value="' . $this->creds['client_id'] . '" readonly="readonly" />
      ...
      if (isset($this->creds['client_secret'])) {
        $form['client_secret'] = [
          '#markup' => Markup::create('<div class="clientSecretContainer"><label for="client_secret" class="field__label">' . t('Secret') . '</label><div class="bx--form-item appSecret js-form-item form-item js-form-type-textfield form-group"><input id="clientSecretInput" class="clipboardjs" aria-labelledby="clientSecretInputLabel" value="' . $this->creds['client_secret'] . '" readonly="readonly" />
