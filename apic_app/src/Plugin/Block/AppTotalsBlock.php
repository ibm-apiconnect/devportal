...
/**
 * @file
 * Contains \Drupal\apic_app\Plugin\Block\AppTotalsBlock.
 */
...
/**
 * Provides a block with the Total calls, errors, etc information for a given application.
 *
 * @Block(
 *   id = "app_totals",
 ...
 *
 */
class AppTotalsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    return [
      '#theme' => 'app_totals',
      '#attached' => array(
        'library' => array('apic_app/basic', 'apic_app/app_totals'),
      ),
    ];
  }
}