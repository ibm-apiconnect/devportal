...
class AppCostBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @return \Drupal\apic_app\Plugin\Block\AppCostBlock
   */
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition): AppCostBlock {
