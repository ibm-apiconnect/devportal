...
connect is a minimal, re-colorable, multi-column theme which uses HTML5
...
connect 7.x-2.x is a sub-theme of Adaptivetheme, you must download and install
...
* Theme settings and layout: connect includes lots of theme settings including
  the ability to change the layout and support for mobile devices. Visit the
  theme settings page admin/appearance/settings/connect to configure your settings.
...
* Color options: Enable the theme at admin/appearance, and visit
  admin/appearance/settings/connect to modify the color scheme if desired.

* Menus: The connect theme does not support the hard coded menu defaults. To setup
...
connect supports the Superfish module which is a dynamic menu module and enables
