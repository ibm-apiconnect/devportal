...
class OidcRegistryService implements OidcRegistryServiceInterface {
  ...
  private function getOidcUrl(UserRegistry $registry, JWTToken $invitation_object = NULL) {
    ...
    $url = $url . '&realm=' . $registry->getRealm(); // TODO: need to support multiple IDPS.
    $url = $url . '&response_type=code';
    if (isset($invitation_object)) {
      $url = $url . '&token=' . $invitation_object->getDecodedJwt();
    }
