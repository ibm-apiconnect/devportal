Feature: Sign in/ Sign up via an OIDC provider
  ...
  #   And I am at "/ibm_apim/oauth2/redirect?code=validauthcode&state=czozOiJrZXkiOyA="
  #   Then I should be on "/"
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/redirect?state=czozOiJrZXkiOyA="
  #   Then I should be on "/"
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=clientId&state=czozOiJrZXkiOyA=&redirect_uri=/ibm_apim/oauth2/redirect&realm=consumer:orgId:envId/trueRealm&response_type=code&action=signin"
  #   Then I should be on "/"
  #   And there are no errors
  #   And there are no warnings
  #   And there are no messages
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?state=czozOiJrZXkiOyA=&redirect_uri=/ibm_apim/oauth2/redirect&realm=consumer:orgId:envId/trueRealm&response_type=code"
  #   Then I should be on "/"
  #   And there are errors
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=clientId&state=czozOiJrZXkiOyA=&realm=consumer:orgId:envId/trueRealm&response_type=code"
  #   Then I should be on "/"
  #   And there are errors
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=clientId&state=czozOiJrZXkiOyA=&redirect_uri=/ibm_apim/oauth2/redirect&response_type=code"
  #   Then I should be on "/"
  #   And there are errors
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=clientId&state=czozOiJrZXkiOyA=&redirect_uri=/ibm_apim/oauth2/redirect&realm=consumer:orgId:envId/trueRealm"
  #   Then I should be on "/"
  #   And there are errors
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=wrongclientId&state=czozOiJrZXkiOyA=&redirect_uri=/ibm_apim/oauth2/redirect&realm=consumer:orgId:envId/trueRealm&response_type=code"
  #   Then I should be on "/"
  #   And there are errors
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=clientId&state=czozOiJrZXkiOyA=&redirect_uri=www.fail.com/ibm_apim/oauth2/redirect&realm=consumer:orgId:envId/trueRealm&response_type=code"
  #   Then I should be on "/"
  #   And there are errors
  #   And I should see the text "Error while authenticating user. Please contact your system administrator."
  #   And there are no warnings
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/authorize?client_id=clientId&state=czozOiJrZXkiOyA=&redirect_uri=/ibm_apim/oauth2/redirect&realm=wrongconsumer:orgId:envId/trueRealm&response_type=code"
  #   Then I should be on "/"
  #   And there are errors
  #   And I should see the text "Error while authenticating user. Please contact your system administrator."
  #   And there are no warnings
  ...
  #   And I am at "/ibm_apim/oauth2/redirect?code=noorgenabledonboarding&state=czozOiJrZXkiOyA="
  ...
  #     | name      | mail                  | pass     | status |
  #     | oidcandre | oidcandre@example.com | oidcoidc | 1      |
  #   And I am at "/ibm_apim/oauth2/redirect?code=noorgdisabledonboarding&state=czozOiJrZXkiOyA="
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/redirect?code=routetoerror&state=czozOiJrZXkiOyA="
  #   Then I should be on "/"
  #   And there are errors
  #   And I should see the text "Error while authenticating user. Please contact your system administrator."
  #   And there are no warnings
  ...
  #   Given I am not logged in
  #   And I am at "/ibm_apim/oauth2/redirect?code=fail&state=czozOiJrZXkiOyA="
  ...
  #   And I am at "/ibm_apim/oauth2/redirect?code=firsttimelogin&state=czozOiJrZXkiOyA="
