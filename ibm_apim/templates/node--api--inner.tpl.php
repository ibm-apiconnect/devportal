  ...
  <div class="navigate-apis">
    <div class="readAndInteract">
      ...
      <section
        ...
        <div class="documentationContent apicSelfClear">
          <div class="titleHeader">
            ...
            <h1 class="name">
              <span><?php print $api['info']['title']; ?> <span class="version"><?php print $api['info']['version']; ?></span></span>
            </h1>
            <div class="downloadButton">
              <?php if ($protocol != 'wsdl') : ?>
                <a
                  ...
                  target='_blank'>
                  <button style="margin-top: -12px;" title="<?php print t('Download'); ?>">
                    <span class="material-icons">file_download</span> <?php print t('Swagger'); ?>
                  </button>
                </a>
          ...
          <div class="info">
            ...
            <?php if (isset($api['info']['description']) && !empty($api['info']['description'])) : ?>
              <div>
                ...
                <div class="markdown"><?php print ibm_apim_markdown_field($api['info']['description']); ?></div>
              </div>
            <?php endif; ?>
          ...
          <?php if (isset($api['info']['contact']) && ((isset($api['info']['contact']['name']) && !empty($api['info']['contact']['name'])) || (isset($api['info']['contact']['email']) && !empty($api['info']['contact']['email'])) || (isset($api['info']['contact']['url']) && !empty($api['info']['contact']['url'])))) : ?>
            <div class="contactContainer">
              <div class="contactLink"><a onclick='API.togglesection("contact")' href='javascript:;'><span
          ...
          <?php if ((isset($api['info']['license']) && isset($api['info']['license']['url']) && isset($api['info']['license']['name']) && !empty($api['info']['license']['url']) && !empty($api['info']['license']['name'])) || (isset($api['info']['termsOfService']) && !empty($api['info']['termsOfService']))) : ?>
            <div class="licenseContainer">
              <div class="licenseLink"><a onclick='API.togglesection("license")' href='javascript:;'><span
                    class="expand_more"><i class="material-icons">expand_more</i></span><span class="expand_less"><i
          ...
          <?php foreach ($api as $childname => $child) : ?>
            <?php if (_ibm_apim_startsWith(strtolower($childname), 'x-') && !_ibm_apim_startsWith(strtolower($childname), 'x-ibm-')) : ?>
              <div class="vendorExtension">
                <label><?php print $childname; ?></label>
                <div>
                  <pre class="inlineSchema"><code><?php print json_encode($child, JSON_PRETTY_PRINT); ?></code></pre>
                </div>
              </div>
            <?php endif; ?>
          <?php endforeach; ?>
      ...
      <section class="interact" style="padding: 0;">
        <div class="rightHeader stick <?php print $protocol . ' ' . strtolower($ibm_apim_soap_codesnippets); ?>">
          <div class="tableWrapper">
            <?php if ($protocol != 'wsdl' || $ibm_apim_soap_codesnippets == TRUE) : ?>
              <ul class="langs-menu">
            ...
            <?php endif; ?>
            <div class="subscribeButton"><div class="subscribeButtonInner"><a style="font-weight: 500;"
                                                                              href="<?php print url('node/' . $productnid, array(), 'plans'); ?>"><?php print t('Subscribe'); ?></a></div></div>
          </div>
        </div>
        <div style="padding: 50px 15px 15px 15px;" "<?php print $content_attributes; ?>">
    ...
    <?php foreach ($expandedapi['paths'] as $pathSegment => $path) : ?>
                    ...
                    <div class='operationContent'>
                      ...
                      <?php if (isset($operation['summary']) && !empty($operation['summary'])) : ?>
                        <div>
                          ...
                          <div class="markdown"><?php print ibm_apim_markdown_field($operation['summary']); ?></div>
                        </div>
                      <?php endif; ?>
                      <?php if (isset($operation['description']) && !empty($operation['description'])) : ?>
                        <div>
                          <label><?php print t('Description'); ?></label>
                          <div class="markdown"><?php print ibm_apim_markdown_field($operation['description']); ?></div>
                        </div>
                      <?php endif; ?>
                            ...
                            <?php foreach ($securityArray as $securityDefName => $securityDef) : ?>
                              <div class='securitySection listContent'>
                                <div
                                  ...
                                  class='description markdown'><?php print ibm_apim_markdown_field($api['securityDefinitions'][$securityDefName]['description']); ?></div>
                              </div>
                            <?php endforeach; ?>
                          <?php endforeach; ?>
                        <?php endif; ?>
                          ...
                          <?php foreach ($api['securityDefinitions'] as $securityDefName => $securityDef) : ?>
                            <div class='securitySection listContent'>
                              <div class='name'><?php if (isset($securityDef['name'])) {
                                ...
                                class='description markdown'><?php if (isset($securityDef['description'])) {
                        ...
                        <?php if ($protocol != 'wsdl') : ?>
                          <div class="parameters">
                            ...
                            <?php if (isset($path['parameters']) && is_array($path['parameters'])): ?>
                              <?php foreach ($path['parameters'] as $parameter) : ?>
                                ...
                                <div class='parametersSection listContent'>
                                  <div class='name'><div class="title"><?php print $parameter['name']; ?></div>
                                    ...
                                    <div
                                      ...
                                      <?php if (isset($parameter) && isset($parameter['schema']) && isset($parameter['schema']['$ref'])) : ?>
                                        <a
                                          onclick='API.navigatedefs("<?php print drupal_html_class($api['info']['x-ibm-name'] . $api['info']['version']); ?>", "<?php print preg_replace("/\W/", "", _ibm_apim_ref_to_objectname($parameter['schema']['$ref'])); ?>")'
                                      ...
                                      <?php elseif (isset($parameter) && isset($parameter['schema']['type']) && $parameter['schema']['type'] == "array" && isset($parameter['schema']['items']) && isset($parameter['schema']['items']['$ref'])) : ?>
                                        <a
                                          onclick='API.navigatedefs("<?php print drupal_html_class($api['info']['x-ibm-name'] . $api['info']['version']); ?>", "<?php print preg_replace("/\W/", "", _ibm_apim_ref_to_objectname($parameter['schema']['items']['$ref'])); ?>")'
                                          href='javascript:;'><?php print ibm_apim_return_schema($parameter); ?></a>
                            ...
                            <?php if (isset($operation['consumes']) || isset($api['consumes'])) : ?>
                              <div class='parametersSection listContent'>
                                <div class='name'><div class="title">Content-Type</div>
                                  <div class='located-in'><?php print t('Optional in header'); ?>
                                  </div></div><div class="schemawrapper"><div
                                    class='description'></div><div class='schema'>
                            ...
                            <?php if (isset($operation['produces']) || isset($api['produces'])) : ?>
                              <div class='parametersSection listContent'>
                                <div class='name'><div class="title">Accept</div>
                                  <div class='located-in'><?php print t('Optional in header'); ?>
                                  </div></div><div class="schemawrapper"><div
                                    class='description'></div><div class='schema'>
                            ...
                            <?php foreach ($operation['parameters'] as $parameter) : ?>
                              <?php if (isset($parameter['in']) && $parameter['in'] == 'body') : ?>
                                <div>
                                  ...
                                  <?php else : ?>
                                    <pre
                                      class="hljs inlineSchema"><code><?php print htmlspecialchars($parameter['schema']); ?></code></pre>
                                  <?php endif; ?>
                                </div>
                              <?php endif; ?>
                            <?php endforeach; ?>
                      ...
                      <div
                        ...
                        <div class="langtab">
                          <div
                            ...
                            class="curl langtab-content show">
                                ...
                                <div class="contrast apimAuthUrl hidden">
                                  ...
                                  <?php if (TRUE == FALSE) : ?>
                                    ...
                                    <div class="parameter twolegged buttons hidden">
                                      <button type="button"
                                              onclick="API.forgetToken('<?php print $api['info']['x-ibm-name'] . $api['info']['version']; ?>', '<?php print $verb ?>', '<?php print $pathSegment ?>')"
          ...
          <section
            ...
            <div class="definitionsWrapper">
              <?php foreach ($api['definitions'] as $definitionName => $definition) : ?>
                <label
                  class="navigate-apis_<?php print drupal_html_class($api['info']['x-ibm-name'] . $api['info']['version']); ?>_definitions_<?php print drupal_html_class($definitionName); ?>"><?php print $definitionName; ?></label>
