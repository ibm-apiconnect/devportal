(function ($) {
    ...
    function Product(product, apis, expandedapis) {
        ...
        function cleanUpClassName(input) {
            ...
            input = input.replace(" ", "-").replace("_", "-").replace("[", "-").replace("]", "-");
            ...
            if (empty == true) {
                ...
                if (property.enum && property.enum.length > 0) {
                    ...
                    if (property.format && (property.format == 'date' || property.format == 'date-time')) {
                        ...
                        if (propertyName) {
                            if (propertyName.toLowerCase().indexOf('address') > -1) {
                                return chance.address();
                            } else if (propertyName.toLowerCase().indexOf('phone') > -1) {
                                return chance.phone();
                            } else if (propertyName.toLowerCase().indexOf('areacode') > -1) {
                                return chance.areacode();
                            } else if (propertyName.toLowerCase().indexOf('post') > -1) {
                                return chance.postal();
                            } else if (propertyName.toLowerCase().indexOf('city') > -1) {
                                return chance.city();
                            } else if (propertyName.toLowerCase().indexOf('province') > -1) {
                                return chance.province();
                            } else if (propertyName.toLowerCase().indexOf('street') > -1) {
                                return chance.street();
                            } else if (propertyName.toLowerCase().indexOf('state') > -1) {
                                return chance.state();
                            } else if (propertyName.toLowerCase().indexOf('country') > -1) {
                                return chance.country({full: true});
                            } else if (propertyName.toLowerCase().indexOf('zip') > -1) {
                                return chance.zip();
                            } else if (propertyName.toLowerCase().indexOf('coordinate') > -1) {
                                return chance.coordinates();
                            } else if (propertyName.toLowerCase().indexOf('latitude') > -1) {
                                return chance.latitude();
                            } else if (propertyName.toLowerCase().indexOf('longitude') > -1) {
                                return chance.longitude();
                            } else if (propertyName.toLowerCase().indexOf('cc') > -1 || propertyName.toLowerCase().indexOf('credit') > -1) {
                                return chance.cc();
                            } else if (propertyName.toLowerCase().indexOf('expiry') > -1) {
                                return chance.exp();
                            } else if (propertyName.toLowerCase().indexOf('currency') > -1) {
                                return chance.currency().code;
                            } else if (propertyName.toLowerCase().indexOf('color') > -1 || propertyName.toLowerCase().indexOf('colour') > -1) {
                                return chance.color({format: 'hex'});
                            } else if (propertyName.toLowerCase().indexOf('domain') > -1) {
                                return chance.domain();
                            } else if (propertyName.toLowerCase().indexOf('email') > -1 || propertyName.toLowerCase().indexOf('e-mail') > -1) {
                                return chance.email();
                            } else if (propertyName.toLowerCase().indexOf('url') > -1) {
                                return chance.url();
                            } else if (propertyName.toLowerCase().indexOf('twitter') > -1) {
                                return chance.twitter();
                            } else if (propertyName.toLowerCase().indexOf('birth') > -1 || propertyName.toLowerCase().indexOf('bday') > -1) {
                                return chance.birthday({string: true});
                            } else if (propertyName.toLowerCase().indexOf('age') > -1) {
                                return chance.age();
                            } else if (propertyName.toLowerCase().indexOf('first') > -1 || propertyName.toLowerCase().indexOf('fname') > -1 || propertyName.toLowerCase().indexOf('user') > -1) {
                                return chance.first();
                            } else if (propertyName.toLowerCase().indexOf('last') > -1 || propertyName.toLowerCase().indexOf('lname') > -1) {
                                return chance.last();
                            } else if (propertyName.toLowerCase().indexOf('gender') > -1 || propertyName.toLowerCase().indexOf('sex') > -1) {
                                return chance.gender();
                            } else if (propertyName.toLowerCase().indexOf('prefix') > -1) {
                                return chance.prefix();
                            } else if (propertyName.toLowerCase().indexOf('ssn') > -1 || propertyName.toLowerCase().indexOf('social') > -1) {
                                return chance.ssn();
                            } else if (propertyName.toLowerCase().indexOf('token') > -1) {
                                return chance.apple_token();
                            } else if (propertyName.toLowerCase().indexOf('number') > -1) {
                                return chance.natural();
                            } else if (propertyName.toLowerCase().indexOf('year') > -1) {
                                return chance.year({min: 1900, max: 2100});
                            } else if (propertyName.toLowerCase().indexOf('month') > -1) {
                                return chance.month();
                            } else if (propertyName.toLowerCase().indexOf('date') > -1) {
                                return chance.date({string: true});
                            } else if (propertyName.toLowerCase().indexOf('timestamp') > -1) {
                                return chance.timestamp();
                            } else if (propertyName.toLowerCase().indexOf('time') > -1) {
                                return chance.hour({twentyfour: true}) + ':' + chance.minute();
                            } else if (propertyName.toLowerCase().indexOf('hour') > -1) {
                                return chance.hour({twentyfour: true});
                            } else if (propertyName.toLowerCase().indexOf('minute') > -1) {
                                return chance.minute();
                            } else if (propertyName.toLowerCase().indexOf('string') > -1) {
                                return chance.string();
                            } else if (propertyName.toLowerCase().indexOf('desc') > -1) {
                                return chance.paragraph({sentences: 1});
                            } else if (propertyName.toLowerCase().indexOf('message') > -1) {
                                return chance.sentence();
                            } else if (propertyName.toLowerCase().indexOf('name') > -1) {
                                return chance.name();
                            } else if (propertyName.toLowerCase().indexOf('ip') > -1) {
                                return chance.ip();
                            } else if (propertyName.toLowerCase().indexOf('id') > -1) {
                                return chance.natural();
                            } else {
                                var stringMax = 8;
                                var stringMin = 4;
         ...
         * @returns {*}
         */
        function createExampleObject(schema, empty) {
            if (empty == null) {
                empty = false;
            }
            var result = {};
                ...
                if (!schema.properties) {
                                        ...
                                        if (schema.allOf[key].allOf[key2].properties) {
                                            Object.keys(schema.allOf[key].allOf[key2].properties).forEach(function (propertyName) {
                                                ...
                                                if (schema.allOf[key].allOf[key2].properties[propertyName].type === 'object' || schema.allOf[key].allOf[key2].properties[propertyName].type === 'array' || (!schema.allOf[key].allOf[key2].properties[propertyName].type && schema.allOf[key].allOf[key2].properties[propertyName].properties)) {
                                                    ...
                                                    result[propertyName] =
                                                        createExampleObject(schema.allOf[key].allOf[key2].properties[propertyName], empty);
                                ...
                                if (schema.allOf[key].properties) {
                                    Object.keys(schema.allOf[key].properties).forEach(function (propertyName) {
                                        ...
                                        if (schema.allOf[key].properties[propertyName].type === 'object' || schema.allOf[key].properties[propertyName].type === 'array' || (!schema.allOf[key].properties[propertyName].type && schema.allOf[key].properties[propertyName].properties)) {
                                            ...
                                            result[propertyName] =
                                                createExampleObject(schema.allOf[key].properties[propertyName], empty);
                                            // otherwise use the defaultValues hash
                                        } else {
                    ...
                    Object.keys(schema.properties).forEach(function (propertyName) {
                        ...
                        if (schema.properties[propertyName].type === 'object' || schema.properties[propertyName].type === 'array' || (!schema.properties[propertyName].type && schema.properties[propertyName].properties)) {
                            ...
                            result[propertyName] =
                                createExampleObject(schema.properties[propertyName], empty);
                ...
                if (!obj.properties) {
                                            ...
                                            if (obj.allOf[key].allOf[key2].properties) {
                                                Object.keys(obj.allOf[key].allOf[key2].properties).forEach(function (propertyName) {
                                                    ...
                                                    if (obj.allOf[key].allOf[key2].properties[propertyName].type === 'object' || obj.allOf[key].allOf[key2].properties[propertyName].type === 'array' || (!obj.allOf[key].allOf[key2].properties[propertyName].type && obj.allOf[key].allOf[key2].properties[propertyName].properties)) {
                                                        ...
                                                        result[propertyName] =
                                                            createExampleObject(obj.allOf[key].allOf[key2].properties[propertyName], empty);
                                                        // otherwise use the defaultValues hash
                                                    } else {
                                ...
                                if (obj.allOf[key].properties) {
                                    Object.keys(obj.allOf[key].properties).forEach(function (propertyName) {
                                        ...
                                        if (obj.allOf[key].properties[propertyName].type === 'object' || obj.allOf[key].properties[propertyName].type === 'array' || (!obj.allOf[key].properties[propertyName].type && obj.allOf[key].properties[propertyName].properties)) {
                                            ...
                                            result[propertyName] =
                                                createExampleObject(obj.allOf[key].properties[propertyName], empty);
                                            // otherwise use the defaultValues hash
                                        } else {
                    ...
                    Object.keys(obj.properties).forEach(function (propertyName) {
                        ...
                        if (obj.properties[propertyName].type === 'object' || obj.properties[propertyName].type === 'array' || (!obj.properties[propertyName].type && obj.properties[propertyName].properties)) {
                            ...
                            result[propertyName] =
                                createExampleObject(obj.properties[propertyName], empty);
                            // otherwise use the defaultValues hash
                        } else {
        ...
        function createTesters() {
            self.testers = {};
            self.product.expandedapis.forEach(function (api) {
                Object.keys(api.paths).forEach(function (path) {
    ...
    Product.prototype.test = function (apiname, verb, path) {
    ...
    Product.prototype.authorize = function (apiname, verb, path) {
        var tester = this.testers[apiname + "_" + verb + "_" + path];
        if (tester) {
            tester.authorize();
        }
    ...
    Product.prototype.refreshToken = function (apiname, verb, path) {
        var tester = this.testers[apiname + "_" + verb + "_" + path];
        if (tester) {
            tester.refreshToken();
        }
    ...
    Product.prototype.forgetToken = function (apiname, verb, path) {
        var tester = this.testers[apiname + "_" + verb + "_" + path];
        if (tester) {
            tester.forgetToken();
        }
    ...
    Product.prototype.navigateop = function (path, expand) {
        this.userNavigate = true;
        this.setSelectedPath(path, null, expand);
        var node = document.querySelector('.productDetails .navigate-' + path);
        if (node) {
    ...
    Product.prototype.navigatedefs = function (api, def, expand) {
        $(".definitions_toggle_apis-" + api).addClass("open");
        this.userNavigate = true;
        this.setSelectedPath('apis_' + api + '_definitions_' + def, null, expand);
        var node = document.querySelector('.productDetails .navigate-' + 'apis_' + api + '_definitions_' + def);
        if (node) {
            node.scrollIntoView();
            window.scrollBy(0, -150);
        }
    ...
    Product.prototype.selecttag = function (api, tag) {
    ...
    Product.prototype.unselecttag = function (api) {
    ...
    Product.prototype.toggleop = function (operation) {
        $(".opwrapper-" + operation).toggleClass("open");
    };
    Product.prototype.toggledefs = function (api) {
